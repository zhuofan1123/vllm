...
class ReqContext:
    ...
    # The request's block hashes (hash_block_size granularity, growing as the
    # request runs), for managers that index by prefix rather than by key.
    block_hashes: Sequence[bytes] | None = None
